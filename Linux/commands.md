...
9. cd .. --> one directory back. 
10. cd 'directory name or folder name'. 
11. cd / --> Root directory. 
12. cd ~ --> Hoome directory.
13. cd /home/user/Document --> Absolute path. 
14. cd /Document --> Relative path.
15. mkdir --> Creates directory.
